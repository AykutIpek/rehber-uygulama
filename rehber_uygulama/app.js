...
function kisiyiEkle(eklenecekKisi){
    ...
    <td>
        ...
        <button class="btn btn--trash"><i class="far fa-trash-alt"></i></button>
    </td>`;
...
function bilgiOlustur(mesaj,durum){
    ...
    if(durum){
        ...
        olusturulanBilgi.classList.add = ('bilgi--trash');
    }
    document.querySelector('.container').insertBefore(olusturulanBilgi,form);
    */
   olusturulanBilgi.classList.add(durum ? 'bilgi--success' : 'bilgi--trash');
   document.querySelector('.container').insertBefore(olusturulanBilgi,form);
